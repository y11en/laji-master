...
export default {
    ...
    methods: {
        ...
        async bookChart() {
            ...
            await this.$store.dispatch('getExtensionstatisticsData', data1).then(res => {
            ...
            this.$store.dispatch('getExtensionstatisticsData', data2).then(res => {
                if(res.returnCode === 200) {
                    for(let i=0; i<xAxis.length; i++) {
                        if(this.showStrUp === '按日查询') {
        ...
        bookTable() {
            ...
            this.$store.dispatch('getUserExtensionstatisticsCreateBookInfo', data).then(res => {
                if(res.returnCode === 200) {
