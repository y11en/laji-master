<template>
    <div class="sys-notice-wrap">
        ...
        <el-row class="mbt20">
            <el-table ref="multipleTable" :data="tableList.list" border select="row" tooltip-effect="dark">
...
<script type="text/ecmascript-6">
    export default{
        ...
        methods: {
            getNotice() {
                this.$store.dispatch('system/getNotice', { menuId: this.currentType, page: this.$route.params.page }).then(res => {
            ...
            delNotice(id) {
                this.$confirm('此操作将永久删除该公告, 是否继续?', '提示', {
                    ...
                    this.$store.dispatch('system/deleteNotice', { id: id }).then(res => {
