...
const router = new Router({
    ...
    routes: [
        ...
        { path: '/board', name: 'board', component: () => import('@/page/board') },

        { path: '/sensitiveWord', name: 'SensitiveWord', component: () => import('@/page/sensitiveWord.vue') },

        // 书籍管理
        // 书籍列表
        { path: '/book/list', redirect: 'book/list/1' },
        { path: '/book/list/:page', name: 'bookList', meta: { keepAlive: true }, component: () => import('@/page/book/book.vue') },
        { path: '/book/info/:bid', name: 'bookInfo', meta: { keepAlive: true }, component: () => import('@/page/book/book.vue') },
        ...
        // -----------------属性管理
        { path: '/property', name: 'property', component: () => import('@/page/property.vue') },
        ...
        { path: '/authority/administrator/:page', name: 'autAdministrator', component: () => import('@/page/power/admin.vue') },
        // 角色管理
        { path: '/authority/role', redirect: 'authority/role/1' },
        { path: '/authority/role/:page', name: 'autRole', component: () => import('@/page/power/role_list.vue') },
        // 资源管理
        { path: '/authority/resource', name: 'autResource', component: () => import('@/page/power/resource.vue') },
        
        // -----------------系统管理
        // 数据导出
        { path: '/system/export', name: 'sysExport', component: () => import('@/page/system/export.vue') },
        // 清理缓存
        { path: '/system/cache', name: 'sysCache', component: () => import('@/page/system/cache.vue') },
        // 屏蔽词管理
        { path: '/system/shield', redirect: 'system/shield/1' },
        { path: '/system/shield/:page', name: 'sysShield', component: () => import('@/page/system/shield.vue') },
        // 版本更新
        { path: '/system/version', redirect: 'system/version/1' },
        { path: '/system/version/:page', name: 'sysVersion', component: () => import('@/page/system/version.vue') },
        
        // -----------------推荐管理*
        // 限时免费
        { path: '/system/deadline', redirect: 'system/deadline/1' },
        { path: '/system/deadline/:page', name: 'sysDeadline', component: () => import('@/page/recommend/deadline.vue') },
        // 活动推荐
        { path: '/system/actives', name: 'sysActives', component: () => import('@/page/recommend/actives.vue') },
        // 首页管理
        { path: '/system/recommend', redirect: 'system/recommend/1' },
        { path: '/system/recommend/:page', name: 'sysRecommend', component: () => import('@/page/recommend/recommend.vue') },
        
        // -----------------新闻公告*
        { path: '/system/notice', redirect: 'system/notice/1' },
        { path: '/system/notice/:page', name: 'sysNotice', component: () => import('@/page/recommend/notice.vue') },
        ...
        // 新增书籍
        { path: '/appstatistics/newbook', redirect: '/appstatistics/newbook/1' },
        { path: '/appstatistics/newbook/:page', name: 'createBook', component: () => import('@/page/census/createBook.vue') },
