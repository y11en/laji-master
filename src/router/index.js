...
const router = new Router({
  ...
  routes: [
    ...
    { path: '/board', name: 'Board', components: require('../components/system/board') },
    { path: '/sensitiveWord', name: 'SensitiveWord', components: require('../components/sensitiveWord.vue') },
    ...
    { path: '/author/monthly/:aid/:page', name: 'authorMonReport', components: require('../components/statistics/monthly.vue') },
    { path: '/author/add_monthly/:aid', name: 'authorAddMonReport', components: require('../components/statistics/add_monthly.vue') },
    { path: '/author/edit_monthly/:bid', name: 'authorEditMonReport', components: require('../components/statistics/add_monthly.vue') },
    ...
    { path: '/statistics/monthly/:page', name: 'staBookMonthly', components: require('../components/statistics/monthly.vue') },
    ...
    // 数据导出
    { path: '/system/export', name: 'sysExport', components: require('../components/system/export.vue') },
    // 数据字典
    { path: '/system/dictionary', name: 'sysDictionary', components: require('../components/system/dictionary.vue') },
    // 数据备份
    { path: '/system/backups', name: 'sysBackups', components: require('../components/system/backups.vue') },
    // 清理缓存
    { path: '/system/cache', name: 'sysCache', components: require('../components/system/cache.vue') },
    // 屏蔽词管理
    { path: '/system/shield', redirect: 'system/shield/1' },
    { path: '/system/shield/:page', name: 'sysShield', components: require('../components/system/shield.vue') },
    // 友情链接
    { path: '/system/blogroll', redirect: 'system/blogroll/1' },
    { path: '/system/blogroll/:page', name: 'sysBlogroll', components: require('../components/system/blogroll.vue') },
    // 版本更新
    { path: '/system/version', redirect: 'system/version/1' },
    { path: '/system/version/:page', name: 'sysVersion', components: require('../components/system/version.vue') },

    // 日志管理
    // 登录日志
    { path: '/record/login', redirect: 'record/login/1' },
    { path: '/record/login/:page', name: 'recLogin', components: require('../components/record/login_log.vue') },
    // 操作日志
    { path: '/record/operate', redirect: 'record/operate/1' },
    { path: '/record/operate/:page', name: 'recOperate', components: require('../components/record/operate_log.vue') },

    // 运行监控
    // Tomcat监控
    { path: '/monitor/tomcat', name: 'monTomcat', components: require('../components/monitor/tomcat.vue') },
    // Nginx监控
    { path: '/monitor/nginx', name: 'monNginx', components: require('../components/monitor/nginx.vue') },
    // 系统监控
    { path: '/monitor/system', name: 'monSystem', components: require('../components/monitor/system.vue') },
    // druid监控
    { path: '/monitor/druid', name: 'monDruid', components: require('../components/monitor/druid.vue') },
    // 数据库监控
    { path: '/monitor/mysql', name: 'monMyspl', components: require('../components/monitor/mysql.vue') },
    // Redits 监控
    { path: '/monitor/redis', name: 'monRedis', components: require('../components/monitor/redis.vue') },
