...
<div class="admin-book-wrap">
    ...
    <el-row>
        <el-table
            ...
            <el-table-column width="80" label="封面">
                <template slot-scope="scope">
                    <div class="cover-wrap" @click="dialogShow(scope.row)">
                        ...
                        <div class="remark" v-if="scope.row.bookRemarks"></div>
                        <div class="remark-font" v-if="scope.row.bookRemarks">豆腐小说</div>
                    </div>
                </template>
            </el-table-column>
            ...
            <el-table-column label="是否连载" align="center">
                <template slot-scope="scope">
            ...
            <el-table-column label="最后更新" align="center">
                <template slot-scope="scope">
                    <div>{{scope.row.lastUpdateChapterName}}</div>
                </template>
            </el-table-column>
...
export default{
    ...
    components: {
        'pic-cropper': () => import('../../components/img_upload.vue')
    },
